...
export const updateSecretWordInput =
  (word: string) =>
  ...
  switch (role) {
    case "Master":
      return {
        ...
        description:
          "You are the Master! You will create the secret word that everyone except the Outsider will know.",
        instructions: [
    ...
    case "Outsider":
      return {
        ...
        description:
          "You are the Outsider! You don't know the secret word, but you must blend in and avoid being discovered.",
        instructions: [
    ...
    case "Commoner":
      return {
        ...
        description:
          "You are a Commoner! You will know the secret word and must help identify the Outsider.",
        instructions: [
          "Keep your role SECRET!",
...
const renderRoleAssignment = (currentPlayer: Player.Player): Html => {
  if (Option.isNone(currentPlayer.role)) {
    return div([Class("text-center")], [p([Class("text-gray-600")], ["Assigning roles..."])])
  }
  ...
  return div(
    ...
    [
      ...
      div(
        [
          Class(
            `${roleInfo.bgColor} ${roleInfo.borderColor} border-2 rounded-lg p-6 shadow-lg mb-6`,
          ),
        ],
        [
          div(
              ...
              div(
                ...
                roleInfo.instructions.map((instruction) =>
                  div(
                    ...
                    [span([Class("text-lg mt-0.5")], ["•"]), span([], [instruction])],
                  ),
                ),
              ),
            ],
...
const renderWordCreation = (model: GameModel): Html => {
  ...
  if (!currentPlayer || Option.isNone(currentPlayer.role)) {
    return div([Class("text-center")], [p([Class("text-gray-600")], ["Loading..."])])
  }
        ...
        [
          div(
            ...
            [
              ...
              p(
                [Class("text-purple-700 text-lg")],
                ["Choose a word that everyone except the Outsider will know"],
              ),
            ],
          ),
          ...
          div(
            ...
            [
              div(
                ...
                [
                  ...
                  input([
                    ...
                    OnInput((value) => Message.SecretWordChanged.make({ word: value })),
                    Class(
                      `w-full px-4 py-3 border-2 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-purple-500 ${
                  ...
                  ...(hasError
                    ? [
                        p(
                          ...
                          [Option.getOrElse(model.secretWordError, () => "")],
                        ),
                      ]
                    : []),
                ],
              ...
              button(
                [
                  OnClick(() => Message.SubmitSecretWord.make()),
                  Class(
...
const renderShareSecretWord = (model: GameModel): Html => {
  const currentPlayer = getCurrentPlayer(model.gameState, model.currentPlayerId)
          ...
          [
            ...
            div(
              ...
              [
                ...
                p(
                  [Class("text-red-700 text-lg mb-4")],
                  ["The other players are learning the secret word..."],
                ),
                div([Class("text-3xl font-bold text-red-800 mb-4")], [`${timeRemaining}s`]),
              ],
            ),
            div(
          ...
          div(
            ...
            [
              ...
              div(
                [
                  Class(
                    "text-4xl font-bold text-green-900 bg-white rounded-lg p-4 border-2 border-green-300 mb-4",
                  ),
                ],
            ...
            ? [
                div(
                  ...
                  [
                    button(
                      [
                        OnClick(() => Message.ContinueToGuessing.make()),
                        Class(
...
const renderPlayerGuessing = (model: GameModel): Html => {
  const currentPlayer = getCurrentPlayer(model.gameState, model.currentPlayerId)
  const timeRemaining = Option.getOrElse(model.gameState.phaseTimer, () => 0)
          ...
          div(
            ...
            [
              ...
              p(
                ...
                ["Discuss and give hints about the secret word. Try to identify the Outsider!"],
              ),
            ],
          ),
          ...
          ...(isOutsider
            ? [
                div(
                  ...
                  [
                    h3(
                      [Class("text-lg font-bold text-red-800 mb-2")],
                      ["🕵️ Your Mission (Outsider)"],
                    ),
                    div(
                        ...
                        div(
                          ...
                          [
                            ...
                            span(
                              [],
                              [
                                "Try to participate naturally without revealing you don't know the word",
                              ],
                            ),
                          ],
                        ),
                    ...
                    ...(isMaster
                      ? [
                          div(
                            ...
                            [
                              h4(
                                [Class("text-lg font-semibold text-purple-800 mb-3")],
                                ["Master: Was the word guessed?"],
                              ),
                              p(
                                [Class("text-purple-700 mb-4 text-sm")],
                                [
                                  "Based on the discussion, do you think the Outsider figured out the secret word?",
                                ],
                              ),
                              div(
                                ...
                                [
                                  button(
                                    [
                                      OnClick(() => Message.WordGuessed.make()),
                                      Class(
                                  ...
                                  button(
                                    [
                                      OnClick(() => Message.WordNotGuessed.make()),
                                      Class(
                                        "bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200",
                                      ),
                                    ],
                      ...
                      : [
                          div(
                            ...
                            [
                              p(
                                [Class("text-gray-600")],
                                ["Waiting for the Master to decide if the word was guessed..."],
                              ),
                            ],
                          ),
                        ]),
...
const renderVoting = (model: GameModel): Html => {
  const currentPlayer = getCurrentPlayer(model.gameState, model.currentPlayerId)
  const timeRemaining = Option.getOrElse(model.gameState.phaseTimer, () => 0)
  const minutes = Math.floor(timeRemaining / 60)
  const seconds = timeRemaining % 60
                ...
                [
                  ...
                  div(
                    ...
                    [
                      ...
                      span(
                        [Class("text-gray-900 font-bold text-xl")],
          ...
          ...(allPlayersVoted
            ? [
                div(
                  ...
                  [
                    h3(
                      [Class("text-lg font-bold text-green-800 text-center")],
                      ["🗳️ All Players Have Voted!"],
                    ),
                    p(
            ...
            : [
                div(
                  ...
                  [
                    h3(
                      [Class("text-lg font-bold text-orange-800 text-center")],
                      ["⏳ Waiting for All Votes"],
                    ),
                    p(
                      [Class("text-orange-700 text-center")],
                      [
                        `${totalPlayers - votedPlayersCount} player${totalPlayers - votedPlayersCount === 1 ? "" : "s"} still need to vote`,
                      ],
                    ),
                  ],
                ),
                    ...
                    [
                      OnClick(() => {
                        if (!isCurrentPlayer && !allPlayersVoted) {
                          Message.VoteForPlayer.make({ playerId: player.id })
                        }
                      }),
                      Class("text-center"),
                    ],
                    ...
                    div(
                      ...
                      [
                        span(
                          ...
                          [
                            model.gameState.players.find((p) => p.id === currentVote)?.name ||
                              "Unknown",
                          ],
                        ),
                        ...(allPlayersVoted
                          ...
                          : [
                              span(
                                ...
                                ["(Click another player to change)"],
                              ),
                            ]),
                      ],
                    ),
...
const renderResults = (model: GameModel): Html => {
  ...
  return div(
    ...
    [
      ...
      div(
        [
          Class(
            `text-center p-6 rounded-lg ${commonersWin ? "bg-green-100 border-2 border-green-300" : "bg-red-100 border-2 border-red-300"}`,
          ),
        ],
        [
          h2(
            [Class(`text-3xl font-bold mb-4 ${commonersWin ? "text-green-800" : "text-red-800"}`)],
            [commonersWin ? "🎉 Commoners & Master Win!" : "🎭 Outsider Wins!"],
          ),
          p(
            [Class(`text-lg ${commonersWin ? "text-green-700" : "text-red-700"}`)],
            [
              commonersWin
      ...
      div(
        ...
        [
          h3(
            [Class("text-xl font-bold text-blue-800 mb-3 text-center")],
          ...
          div(
            ...
            [
              span(
                [Class("text-3xl font-bold text-blue-900 bg-blue-200 px-6 py-3 rounded-lg")],
                [secretWord],
              ),
            ],
          ),
          ...
          ...(eliminatedPlayer
            ? [
                div(
                  ...
                  [
                    h4(
                      [Class("text-lg font-bold text-red-800 mb-2 text-center")],
                      ["⚰️ Eliminated"],
                    ),
                    div(
                      [Class("text-center")],
                      [
                        div(
                          [
                            Class(
                              "w-20 h-20 mx-auto mb-3 rounded-full bg-red-200 flex items-center justify-center text-3xl font-bold text-red-800",
                            ),
                          ],
                        ...
                        ...(eliminatedPlayer.role && Option.isSome(eliminatedPlayer.role)
                          ? [
                              p(
                                ...
                                [`Role: ${eliminatedPlayer.role.value}`],
                              ),
                            ]
                          : []),
                      ],
            ...
            : [
                div(
                  [
                    Class(
                      "mb-6 p-4 bg-yellow-100 border-2 border-yellow-300 rounded-lg text-center",
                    ),
                  ],
                  [
                    p(
                      [Class("text-yellow-800 font-bold")],
                      ["No player was eliminated (tie vote or no votes)"],
                    ),
                  ],
                ),
              ]),
              ...
              ...Array.from(voteCounts.entries())
                ...
                .map(([playerId, voteCount]) => {
                  ...
                  return div(
                    [
                      Class(
                        `border-2 rounded-lg p-4 ${playerId === eliminatedPlayerId ? "border-red-400 bg-red-50" : "border-gray-200 bg-white"}`,
                      ),
                    ],
                    [
                      div(
                        ...
                        [
                          div(
                            [
                              Class(
                                `w-12 h-12 mx-auto mb-2 rounded-full flex items-center justify-center text-lg font-bold ${
            ...
            [
              ...players.map((player) => {
                ...
                return div(
                  [
                    Class(
                      `border-2 rounded-lg p-4 ${roleColors[role] || "bg-gray-100 border-gray-300 text-gray-800"}`,
                    ),
                  ],
                  [
                    div(
                      ...
                      [
                        div(
                          [
                            Class(
                              "w-12 h-12 mx-auto mb-2 rounded-full bg-white flex items-center justify-center text-lg font-bold",
                            ),
                          ],
                          [player.name.charAt(0).toUpperCase()],
                        ),
...
export function view(model: GameModel): Html {
  const currentPlayer = getCurrentPlayer(model.gameState, model.currentPlayerId)
            ...
            [
              ...(currentPhase === "RoleAssignment"
                        ...
                        ...(isMaster
                          ? [
                              p(
                                ...
                                [
                                  "When everyone has seen their role, you can continue to word creation.",
                                ],
                              ),
                              button(
                                [
                                  OnClick(() => Message.ContinueToWordCreation.make()),
                                  Class(
                          ...
                          : [
                              p(
                                [Class("text-gray-600")],
                                ["Waiting for the Master to continue..."],
                              ),
                            ]),
                      ],
                    ),
                ...
                : currentPhase === "WordCreation"
                  ? [renderWordCreation(model)]
                  : currentPhase === "ShareSecretWord"
                    ? [renderShareSecretWord(model)]
                    : currentPhase === "PlayerGuessing"
                      ? [renderPlayerGuessing(model)]
                      : currentPhase === "Voting"
                        ? [renderVoting(model)]
